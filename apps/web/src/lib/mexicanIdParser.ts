...
/**
 * Catálogo táctico de Demos Oficiales de RENAPO (CURP con pipes)
 * Formato exacto de las constancias emitidas por la Secretaría de Gobernación:
 * CURP||PATERNO|MATERNO|NOMBRES|SEXO|FECHA_NAC|ENTIDAD|CLAVE_ENTIDAD|
 */
export const CATALOGO_CURP_DEMO = [
  {
    id: 'renapo-1',
    titulo: 'Gustavo Alonso Ruiz Lozano',
    subtitulo: 'Aspirante Nuevo • Candado de Duplicidad Limpio',
    rawCurpText:
      'RULG861230HCHZZS06||RUIZ|LOZANO|GUSTAVO ALONSO|HOMBRE|30/12/1986|CHIHUAHUA|08|',
    curp: 'RULG861230HCHZZS06',
    rfcSugerido: 'RULG8612307C5',
    esDuplicado: false,
  },
  {
    id: 'renapo-2',
    titulo: 'Jorge Alejandro Medina Castillo',
    subtitulo: 'Expediente Existente (sol-101) • Alerta de Reingreso',
    rawCurpText:
      'MECJ920514HCHDRR08||MEDINA|CASTILLO|JORGE ALEJANDRO|HOMBRE|14/05/1992|CHIHUAHUA|08|',
    curp: 'MECJ920514HCHDRR08',
    rfcSugerido: 'MECJ920514QR3',
    esDuplicado: true,
  },
  {
    id: 'renapo-3',
    titulo: 'Rosa María Hinojosa Valles',
    subtitulo: 'Expediente Existente (sol-102) • Alerta de Reingreso',
    rawCurpText:
      'HIVR970822MCHNL02||HINOJOSA|VALLES|ROSA MARIA|MUJER|22/08/1997|CHIHUAHUA|08|',
    curp: 'HIVR970822MCHNL02',
    rfcSugerido: 'HIVR970822PL9',
    esDuplicado: true,
  },
  {
    id: 'renapo-4',
    titulo: 'Carlos Alberto Domínguez Sáenz',
    subtitulo: 'Expediente Existente (sol-103) • Alerta de Reingreso',
    rawCurpText:
      'DOSC850311HCHMN04||DOMINGUEZ|SAENZ|CARLOS ALBERTO|HOMBRE|11/03/1985|CHIHUAHUA|08|',
    curp: 'DOSC850311HCHMN04',
    rfcSugerido: 'DOSC850311KJ1',
    esDuplicado: true,
  },
]
