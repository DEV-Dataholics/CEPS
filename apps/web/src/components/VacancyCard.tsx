    ...
    >
      ...
      <div className="p-5 pb-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-[11px] font-bold px-2 py-0.5 rounded-md bg-slate-100 border border-slate-300 text-slate-700">
                  {vacante.planta}
                </span>
              </div>
              <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 mt-1">
                <MapPin className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                <span>{vacante.zona}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            {estaCubierta ? (
              <span className="px-2.5 py-1 rounded-full text-xs font-extrabold bg-emerald-100 text-emerald-900 border border-emerald-300 flex items-center gap-1 shadow-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-700" />
                Cubierta
              </span>
            ) : (
              <span className="px-2.5 py-1 rounded-full text-xs font-extrabold bg-amber-50 text-amber-900 border border-amber-300 shadow-xs">
